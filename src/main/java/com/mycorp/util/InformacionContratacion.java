...
public class InformacionContratacion implements IInformacionContratacion {

    public InformacionContratacion() {
    }

    @Override
    public InfoContratacion obtenerInfoContratacion(final DatosAlta oDatosAlta, final List<BeneficiarioPolizas>
            lBeneficiarios,
